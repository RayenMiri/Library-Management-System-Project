 ...
 */
public class BibConsCatalogue extends javax.swing.JPanel {
    private static BibConsCatalogue instance;
    public  Utilisateur user;
    /**
     * Creates new form ConsulterCatalogue
     */
    public BibConsCatalogue(Utilisateur user) {
        initComponents();
        this.user= user;
    ...
    public static BibConsCatalogue getInstance(Utilisateur user){
        if(instance!=null){
            return instance;
        }else{
            return new BibConsCatalogue(user);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 110, -1));
